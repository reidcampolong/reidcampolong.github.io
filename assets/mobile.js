  ...
  var initMenu = function() {
    ...
    $sideMenus.each(function() {
      ...
      var $backLink = $('<li class="wsite-menu-back-item">'
        + '<a><span class="wsite-menu-back">Back</span></a>'
        + '</li>');
      ...
      $parentAnchor.after('<span class="wsite-menu-mobile-arrow"></span>');
      $parentAnchor.next('.wsite-menu-mobile-arrow').on('click', function(ev) {
        tweenMenu($previousMenu, $sideMenu, true);
      });
      if ($parentAnchor.hasClass('nonclickable')) {
